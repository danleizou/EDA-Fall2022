...
NTL.phys.data.ex1 <- filter(NTL.phys.data, year4 %in% c(1999))


# Exercise 2: 
# filter NTL.phys.data for Tuesday Lake from 1990 through 1999.
NTL.phys.data.ex2 <- filter(NTL.phys.data, lakename %in% c("Tuesday Lake"), year4 %in% c(1990:1999)) #can also do year4>=1990 & year4<=1999
